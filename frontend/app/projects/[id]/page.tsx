...
export default function ProjectPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0A0A0A]">
      {/* Header */}
      <div className="pt-12 pb-0 px-4 md:px-8 border-b border-[rgba(201,168,76,0.1)]">
          ...
          <div className="flex gap-1">
            {TABS.map(t => (
              <button key={t} onClick={() => setTab(t)}
                className={`font-['IBM_Plex_Sans'] text-sm px-4 py-2.5 border-b-2 transition-all duration-200 ${
                  tab === t
